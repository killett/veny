...
def test_a_renamed_pathlib_import_is_still_evaluated() -> None:
    """The alias set holds local bindings, not pathlib's own class names."""
    assert safe_eval('P("a").joinpath("b")', pathlib_aliases={"P"}) == "a/b"
